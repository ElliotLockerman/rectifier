...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", help="Set output path/filename. Default is same as input, with '_output' appended before the extension. If --overwrite is not set and the file already exists '_n' will be appended, where n is the lowest number such that the resulting filename does not yet exist")
